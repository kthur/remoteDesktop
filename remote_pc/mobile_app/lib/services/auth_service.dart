...
class AuthService extends ChangeNotifier {
  ...
  AuthService() {
    // Check demo user for quick testing if needed
    _autoInitDemoUser();
  }

  void _autoInitDemoUser() {
    // Default demo Google user for development/preview
  ...
  Future<bool> signInWithGoogle() async {
    ...
    // Fallback demo user if native Google auth plugin not configured in desktop/emulator sandbox
    _currentUser = GoogleUserModel(
      id: 'google_user_12345',
      email: 'demo.user@gmail.com',
      displayName: 'Google Account User',
