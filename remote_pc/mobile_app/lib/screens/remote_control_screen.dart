...
class _RemoteControlScreenState extends State<RemoteControlScreen> with WidgetsBindingObserver {
  ...
  bool _showTrackpadOverlay = false;
  ...
  // Handle App Lifecycle for Background Low-Data Mode
  @override
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.paused) {
      debugPrint("📱 App minimized -> Entering Low-Data Background Mode");
      _remoteService.updateAppState(true);
    } else if (state == AppLifecycleState.resumed) {
      debugPrint("📱 App restored -> Resuming Active Video Stream");
  ...
  void _showWindowSelectorMenu() {
    ...
    // Fallback items if server hasn't pushed list yet
                      ...
                      child: ListTile(
                        ...
                        onTap: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Switched view to: ${win["title"]}'),
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Fit to Mobile Resolution Button
              SizedBox(
            ...
            body: SafeArea(
              child: Stack(
                children: [
                  ...
                  // Background Low-Data Mode Banner Overlay
                  ...
                  // Floating Quick Control Bar at Bottom
                  Positioned(
                    bottom: 20,
                    left: 20,
                    right: 20,
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () {
                final auth = Provider.of<AuthService>(context, listen: false);
                _remoteService.connect("ws://localhost:8080", auth.currentUser?.id ?? "google_user_12345", widget.targetDeviceId);
              },
            )
          ],
        ),
